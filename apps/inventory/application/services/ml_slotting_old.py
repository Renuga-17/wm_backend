...
from apps.warehouse.infrastructure.persistence.models import NavigationNode, NavigationEdge, Rack
from apps.inventory.infrastructure.persistence.models import DemandForecast, CongestionPrediction, SlottingScore, AIDecision, AllocationRecommendation
