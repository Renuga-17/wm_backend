...
class Rack(models.Model):
    ...
    zone = models.ForeignKey('zones.Zone', on_delete=models.CASCADE, db_column='zone_id', related_name='racks')
...
class RackCoordinate(models.Model):
    ...
    rack = models.ForeignKey('warehouses.Rack', on_delete=models.CASCADE, db_column='rack_id', related_name='coordinates')
