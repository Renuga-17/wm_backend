...
from .models import OptimizedRoute, RouteSegment, RouteHistory
from .serializers import RouteOptimizeRequestSerializer, OptimizedRouteSerializer
from .services.pathfinding import PathfindingService
import math
...
class RouteViewSet(viewsets.GenericViewSet):
    ...
    def congestion(self, request):
        ...
        from apps.warehouses.models import NavigationEdge
        from apps.warehouses.serializers import NavigationEdgeSerializer
    ...
    def recalculate(self, request):
        ...
        try:
            from apps.warehouses.models import NavigationNode
            start_node = PathfindingService.resolve_location_to_node(warehouse_id, start_str)
